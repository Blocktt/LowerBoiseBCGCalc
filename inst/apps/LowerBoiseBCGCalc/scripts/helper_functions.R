...
#' @param community Bugs or Fish suffix for _user_input folder
#
copy_import_file <- function(import_file, community = NULL) {

  # result folder and files
  # 20260526, mod for community as part of folder name
  path_results_sub <- file.path(path_results, ifelse(is.null(community),
                                                     dn_files_input,
                                                     paste0(dn_files_input,
                                                            "_",
                                                            community)))
